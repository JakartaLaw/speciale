# Extension to code found at: https://github.com/philtabor/Youtube-Code-Repository/blob/master/ReinforcementLearning/DeepQLearning
...
class Agent(object):
    ...
    def load_model(self, name="dqn_model"):
