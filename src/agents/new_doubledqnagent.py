# Extension of code found at: https://github.com/philtabor/Youtube-Code-Repository/blob/master/ReinforcementLearning/DeepQLearning
...
class DDQNAgent(object):
    ...
    def choose_action(self, state):
        ...
        # scaling states to be mean=zero, std=1
    ...
    def learn(self):
        if self.memory.mem_cntr > self.batch_size:
            ...
            # scaling states to be mean=zero, std=1
            state = self.state_scaler.transform(state)
            new_state = self.state_scaler.transform(new_state)
    ...
    def save_model(self, name="ddqn_model"):
        self.q_eval.save(name + ".h5")

    def load_model(self, name="ddqn_model"):
        self.q_eval = load_model(name + ".h5")
        if self.epsilon == 0.0:
            self.update_network_parameters()
